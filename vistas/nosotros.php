...
<div class="menu">
			<nav>
				<ul>
					...
					<li class="select"><a href="nosotros.php"><span><i class="fa fa-suitcase" aria-hidden="true"></i></span>Quienes somos</a></li>
...
<article class="contenedorn">
	<article class="bannernn">
		<h1>LA CALIDAD DE NUESTROS SERVICIOS SE REFLEJAN EN CADA CONSTRUCCION</h1>
		<p>Estamos en constante búsqueda de nuevos materiales, nuevos diseños, nuevas ideas. Nos orientamos exclusivamente a mejorar nuestro trabajo todos los días y a entregar las mejores viviendas posibles, con los mejores acabados, que proporcionen la mejor calidad de vida a nuestros clientes. Que conviertan nuestras casas en sus hogares.</p>
	</article>
